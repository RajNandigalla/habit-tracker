  ...
  return (
    <>
      ...
      >
        ...
        >
          <MainIcon className={`w-7 h-7 absolute transition-transform duration-200 ${isOpen ? 'rotate-45 scale-0' : 'rotate-0 scale-100'}`} />
          <XIcon className={`w-7 h-7 absolute transition-transform duration-200 ${isOpen ? 'rotate-0 scale-100' : '-rotate-45 scale-0'}`} />
        </button>
      </div>
    </>
  );
