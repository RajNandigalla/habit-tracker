...
import { CloudIcon, MoonIcon, BellIcon, ShieldCheckIcon, SmartphoneIcon, ChevronRightIcon, DownloadIcon, UploadIcon, FireIcon, TrashIcon } from '../icons';
...
const ActionRow: React.FC<{
    ...
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-4">
        <div className="flex items-start gap-4">
            <div className={cn("flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-lg", isDanger ? "bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400" : "bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400")}>
                <Icon className="w-5 h-5" />
            </div>
            <div>
                <h3 className={cn("font-semibold", isDanger ? "text-red-700 dark:text-red-400" : "text-slate-800 dark:text-slate-100")}>{title}</h3>
...
export const SettingsView: React.FC<SettingsViewProps> = ({ 
  ...
  const handlePopulateWrapper = () => {
      setConfirmation({
          ...
          message: 'This will replace all your current habits and journal entries with sample data. Are you sure you want to proceed?',
  ...
  const handleClearWrapper = () => {
      setConfirmation({
          isOpen: true,
          title: 'Start Fresh',
          message: 'This will permanently delete all your habits, journal entries, and history. This action cannot be undone.',
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 md:px-8 pb-24 md:pb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                    {/* Data & Storage */}
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-3 px-1">Data & Storage</h2>
                    ...
                    {/* App Preferences */}
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-3 px-1">Preferences</h2>
                ...
                <div className="space-y-6">
                    {/* Data Management */}
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-3 px-1">Data Management</h2>
                        <Card className="space-y-4">
                            <div className="flex flex-col sm:flex-row gap-4 p-2">
                                <Button 
                                    ...
                                    rightIcon={<DownloadIcon className="h-4 w-4 text-slate-500 dark:text-slate-400" />}
                                >
                                    Export Data (JSON)
                                </Button>
                                <div className="flex-1 relative">
                                    ...
                                    <Button 
                                        ...
                                        rightIcon={<UploadIcon className="h-4 w-4 text-slate-500 dark:text-slate-400" />}
                                    >
                                        Import Data (JSON)
                                    </Button>
                                </div>
                    ...
                    {/* Support & About */}
                    <section>
                        <h2 className="text-sm font-bold uppercase tracking-wider text-slate-400 mb-3 px-1">Support</h2>
                     ...
                     {/* Danger Zone */}
                    <section>
                        <h2 className="text-base font-semibold text-red-600 dark:text-red-400 mb-2 px-2">Danger Zone</h2>
      ...
      >
         <div className="space-y-6">
             ...
             <div className="flex justify-end gap-3">
                 <Button variant="secondary" onClick={() => setConfirmation(prev => ({ ...prev, isOpen: false }))}>
                     Cancel
                 </Button>
                 <Button 
