      ...
      <main className="flex-1 overflow-y-auto">
         <div className="max-w-7xl mx-auto px-4 py-6 md:px-8 pb-24 md:pb-8">
            <div className="flex items-center justify-between mb-8">
                <PageTitle 
                title="Journey Log" 
                description="Reflect on your progress and milestones."
                />
                <Button size="sm" onClick={() => setModalOpen(true)} className="hidden md:flex shadow-md">
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center animate-in fade-in zoom-in-95 duration-500">
                ...
                Documenting your journey boosts success rates by 40%. Record your first milestone, thought, or feeling today.
                </p>
                <Button size="lg" onClick={() => setModalOpen(true)} className="hidden md:inline-flex px-8 shadow-xl shadow-indigo-600/20 dark:shadow-indigo-900/20">Write First Entry</Button>
            </div>
            ) : (
