...
import { GlobalStatsGrid, ConsistencyHeatmap, HabitPerformanceChart, GlobalStats, HeatmapData, AIReportModal, MoodCorrelationData, MoodCorrelationCard } from '../modules/ProgressModules';
        ...
        <PageTransition className="bg-slate-50 dark:bg-slate-950">
            <main className="flex-1 overflow-y-auto">
                <div className="max-w-7xl mx-auto px-4 py-6 md:px-8 pb-24 md:pb-8">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-6 gap-4 animate-slide-up" style={{ animationDelay: '0ms' }}>
                        <PageTitle 
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <section className="lg:col-span-2 animate-slide-up" style={{ animationDelay: '400ms', opacity: 0 }}>
                                <ConsistencyHeatmap data={heatmapData} />
                            </section>

                            {/* Bar Chart (Takes up 1/3 on large screens) */}
                            <section className="lg:col-span-1 animate-slide-up" style={{ animationDelay: '500ms', opacity: 0 }}>
