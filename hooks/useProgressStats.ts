...
import { GlobalStats, HeatmapData, MoodCorrelationData } from '../modules/progress';

/**
 * Custom hook to calculate all progress statistics
 * Extracted from Progress page to keep page components logic-free
 */
export const useProgressStats = (habits: Habit[], journalEntries: JournalEntry[]) => {
